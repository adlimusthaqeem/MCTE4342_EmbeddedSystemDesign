...
{
  SPDR = mapValue;
//  if (reading > 253 or finish1)
//  {
//    if (!flag)
//      SPDR = 253, finish1 = true, flag = true;
//    else
//      SPDR = reading - 253, finish1 = false, flag = false;
//  }
//
////  else if (reading<256)
////  SPDR = reading;
//  else if (reading < 253 or finish2)
//  {
//    if (!flag)
//      SPDR = reading, finish2 = true, flag = true;
//    else
//      SPDR = 0, finish2 = false, flag = false;
//  }
